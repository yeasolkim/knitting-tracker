...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Nav */}
      <nav className="px-5 sm:px-8 h-14 flex items-center border-b-2 border-[#d4b896]">
      ...
      <main className="flex-1 flex items-center justify-center px-4">
        <div className="bg-[#fdf6e8] border-2 border-[#d4b896] rounded-xl shadow-[4px_4px_0_#d4b896] p-7 sm:p-9 w-full max-w-sm">
          {/* Logo area */}
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-14 h-14 rounded-lg bg-[#f5edd6] border-2 border-[#d4b896] mb-4">
            ...
            <h1 className="text-xl font-bold text-[#3d2b1f] tracking-tight">코따에 오신 걸 환영해요</h1>
            <p className="text-sm text-[#7a5c46] mt-1.5">로그인하고 도안을 관리해보세요</p>
          </div>
          ...
          <div className="flex items-center gap-1 justify-center mb-7">
            {Array.from({ length: 5 }).map((_, i) => (
              <svg key={i} width="10" height="7" viewBox="0 0 10 7" fill="none">
                <path d="M0,3.5 L2.5,0 L5,3.5 L7.5,0 L10,3.5" stroke="#d4b896" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
              </svg>
            ))}
          </div>
