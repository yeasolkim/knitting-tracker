...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Nav */}
      <nav className="px-5 sm:px-8 h-14 flex items-center border-b-2 border-[#78b0a8]">
      ...
      <main className="flex-1 flex items-center justify-center px-4">
        <div className="bg-[#eef8f5] border-2 border-[#78b0a8] rounded-xl shadow-[4px_4px_0_#78b0a8] p-7 sm:p-9 w-full max-w-sm">
          {/* Logo area */}
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-14 h-14 rounded-lg bg-[#cce6e1] border-2 border-[#78b0a8] mb-4">
          ...
          <div className="flex items-center gap-1 justify-center mb-7">
            {Array.from({ length: 5 }).map((_, i) => (
              <svg key={i} width="10" height="7" viewBox="0 0 10 7" fill="none">
                <path d="M0,3.5 L2.5,0 L5,3.5 L7.5,0 L10,3.5" stroke="#78b0a8" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
              </svg>
            ))}
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-[#3d2b1f] text-[#eef8f5] border-2 border-[#3d2b1f] rounded-lg px-4 py-3 min-h-[48px] text-sm font-semibold tracking-wide hover:bg-[#2a1d15] transition-all shadow-[3px_3px_0_#7a5c46] active:shadow-none active:translate-x-[2px] active:translate-y-[2px]"
          >
      ...
      <footer className="py-5 text-center text-[11px] text-[#a08060] border-t-2 border-[#78b0a8]">
        {t('footer.copyright')}
      </footer>
    </div>
  );
