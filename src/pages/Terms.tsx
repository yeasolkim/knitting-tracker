      ...
      <div className="max-w-2xl mx-auto px-4 py-10 sm:py-16">
        ...
        <div className="space-y-8 text-sm text-[#3d2b1f] leading-relaxed">
          ...
          <section>
            ...
            <p>
              이 약관은 코따(이하 "서비스")가 제공하는 뜨개질 도안 진행 추적 서비스의 이용 조건 및 절차, 서비스 제공자와 이용자의 권리·의무·책임 사항을 규정함을 목적으로 합니다.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="space-y-1.5 list-none">
              <li><span className="font-semibold">① "서비스"</span>란 코따가 제공하는 웹 애플리케이션 및 관련 서비스 일체를 말합니다.</li>
          ...
          <section>
            <h2 className="text-base font-bold text-[#3d2b1f] mb-3 pb-2 border-b-2 border-[#d4b896]">제3조 (약관의 효력 및 변경)</h2>
            <ul className="space-y-1.5 list-none">
          ...
          <section>
            <h2 className="text-base font-bold text-[#3d2b1f] mb-3 pb-2 border-b-2 border-[#d4b896]">제4조 (서비스 이용)</h2>
            <ul className="space-y-1.5 list-none">
          ...
          <section>
            <h2 className="text-base font-bold text-[#3d2b1f] mb-3 pb-2 border-b-2 border-[#d4b896]">제5조 (이용자의 의무)</h2>
          ...
          <section>
            <h2 className="text-base font-bold text-[#3d2b1f] mb-3 pb-2 border-b-2 border-[#d4b896]">제6조 (콘텐츠 및 저작권)</h2>
            <ul className="space-y-1.5 list-none">
          ...
          <section>
            <h2 className="text-base font-bold text-[#3d2b1f] mb-3 pb-2 border-b-2 border-[#d4b896]">제7조 (서비스 중단 및 데이터)</h2>
            <ul className="space-y-1.5 list-none">
          ...
          <section>
            <h2 className="text-base font-bold text-[#3d2b1f] mb-3 pb-2 border-b-2 border-[#d4b896]">제8조 (책임의 제한)</h2>
            <ul className="space-y-1.5 list-none">
          ...
          <section>
            <h2 className="text-base font-bold text-[#3d2b1f] mb-3 pb-2 border-b-2 border-[#d4b896]">제9조 (준거법 및 분쟁 해결)</h2>
            <ul className="space-y-1.5 list-none">
          ...
          <section className="bg-[#fdf6e8] border-2 border-[#d4b896] rounded-xl p-4">
