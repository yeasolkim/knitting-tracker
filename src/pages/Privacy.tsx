      ...
      <div className="max-w-2xl mx-auto px-4 py-10 sm:py-16">
        ...
        <div className="space-y-8 text-sm text-[#3d2b1f] leading-relaxed">
          ...
          <section>
            ...
            <p>
              코따(이하 "서비스")는 이용자의 개인정보를 중요하게 생각합니다. 이 개인정보처리방침은 서비스가 어떤 정보를 수집하고, 어떻게 사용하며, 어떻게 보호하는지 안내합니다. 본 방침은 「개인정보 보호법」 및 관련 법령을 준수합니다.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-[#fdf6e8] border-2 border-[#d4b896] rounded-xl p-4 space-y-1">
              <p><span className="font-semibold">서비스명:</span> 코따 (Kotta)</p>
